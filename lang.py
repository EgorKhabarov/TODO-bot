...
Reduce the number of characters or remove unnecessary events."""
    ...
    "status page 1": {
        "ru": (
            ...
            ("🟥 Важно                              ", "🟨 Сделано не полностью               "),
            ("⭐️ Важно                              ", "🤨 Не уверен                          "),
            ("🟧 Важно но не так                    ", "💡 Идея                                ")
        ),
        "en": (
            ("⬜️ No Status                          ", "✅ Done                               "),
            ("🟥 Important                          ", "🟨 Not completely done                "),
            ("⭐️ Important                          ", "🤨 Not sure                           "),
            ("🟧 Important but not so               ", "💡 Idea                                ")
        )
    },
    "status page 2": {
        "ru": (
